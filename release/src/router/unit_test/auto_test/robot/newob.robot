...
*** Variables ***
${SUITE_SETUP_LOG}     ==== NewOB test Start! ====
${SUITE_DOWN_LOG}     ==== NewOB test End! ====
${USERNAME_1}       admin
...
DO_NEWOB
    ...
    ${data}    Create Dictionary    hook=send_httpd_event()
    WebApply    ${USERNAME_2}    ${PASSWD_2}    ${DUT_PATH_2}    appGet.cgi    ${data}
    sleep    10
