...
document.write('<script type="text/javascript" src="'+TOOLS_PATH+'jquery.js"></script>');
document.write('<script type="text/javascript" src="'+TOOLS_PATH+'jquery.mobile.js"></script>');
